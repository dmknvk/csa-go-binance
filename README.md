...
[![Build Status](https://travis-ci.org/dmknvk/csa-go-binance.svg?branch=master)](https://travis-ci.org/dmknvk/csa-go-binance)
[![GoDoc](https://godoc.org/github.com/dmknvk/csa-go-binance?status.svg)](https://godoc.org/github.com/dmknvk/csa-go-binance)
[![Go Report Card](https://goreportcard.com/badge/github.com/dmknvk/csa-go-binance)](https://goreportcard.com/report/github.com/dmknvk/csa-go-binance)
[![codecov](https://codecov.io/gh/dmknvk/csa-go-binance/branch/master/graph/badge.svg)](https://codecov.io/gh/dmknvk/csa-go-binance)
...
```shell
go get github.com/dmknvk/csa-go-binance/v2
```

For v1 API, it has been moved to `v1` branch, please use:

```shell
go get github.com/dmknvk/csa-go-binance/v1
```
...
```golang
import (
    "github.com/dmknvk/csa-go-binance/v2"
)
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/dmknvk/csa-go-binance) for full references.
...
```go
import (
    "github.com/dmknvk/csa-go-binance/v2/futures"
)
...
```go
import (
    "github.com/dmknvk/csa-go-binance/v2/delivery"
)
